...
import { PenBoxIcon, Trash2Icon, Send } from "lucide-react";
...
export default function TaskComments({ taskId, isAdmin = false, clientKey, currentUserId }: TaskCommentsProps) {
  ...
  // Fetch comments + subscribe to Echo
  useEffect(() => {
    let mounted = true;
    setIsLoading(true);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(baseUrl, {
        ...
        body: JSON.stringify({ message, client_key_id: clientKey }),
      });
    ...
    <Card className="w-full bg-zinc-900/50 border-zinc-800 backdrop-blur-sm">
      ...
      <CardContent className="p-0">
                  ...
                  <div className="p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-zinc-300 leading-relaxed mb-3">{c.message}</p>
        ...
        <div className="p-4 border-t border-zinc-800 bg-zinc-900/30">
          ...
          <p className="text-[11px] text-zinc-600 mt-2 ml-12">
